  ...
  return (
    <div style={{ boxShadow: '0 0 8px 1px rgba(126, 34, 206, .2)' }} className="w-full p-6 bg-white rounded-lg dark:bg-white dark:border-gray-700 my-4">
      ...
      <div className="flex justify-end items-center mt-4">
        <button onClick={onJobClick} className="mx-3 cursor-pointer focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">View detail</button>
      </div>
    </div>
  );
};
...
PostedJobCard.propTypes = {
  data: PropTypes.shape({
    id_job: PropTypes.number.isRequired,
