...
const Sidebar = () => {
  ...
  return (
    <div className="max-w-[1024px] mx-auto mt-20">
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white sm:translate-x-0 dark:bg-white dark:border-gray-700"
        aria-label="Sidebar"
      >
            ...
            <ul className="space-y-2 font-medium">
              <li>
                <button onClick={handlePage}
                  className={`flex items-center p-2 text-purple-700 rounded-lg ${!page ? 'dark:text-purple-700' : 'dark:text-gray-900'} hover:bg-gray-100 dark:hover:bg-purple-50 group`}
                >
